...
resource "aws_lb_target_group_attachment" "mytg1" {
  for_each         = { for k, v in module.ec2_instnace_private : k => v }
...
output "zz_ec2_private" {
  ...
  value = { for ec2_instance, ec2_instance_details in module.ec2_instnace_private : ec2_instance => ec2_instance_details }
}
